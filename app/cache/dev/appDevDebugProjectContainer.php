...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'home_db', 'user' => 'root', 'password' => 'myhome515', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Acme/MyBundle/Entity'))), 'Acme\\MyBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AcmeMyBundle' => 'Acme\\MyBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a9a120900eba85c7b8cb44b333df3beea453207c70fb0384da75d635a56cae6a');
    ...
    /**
     * Gets the 'parser.class' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\MyBundle\Lib\LennarParser A Acme\MyBundle\Lib\LennarParser instance.
     */
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/MyBundle/Resources/views'), 'AcmeMy');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeMyBundle' => 'Acme\\MyBundle\\AcmeMyBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'myhome515',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '327a7dc6ddf39c76b9824363def15ac6286964d7',
            ...
            'kernel.secret' => '327a7dc6ddf39c76b9824363def15ac6286964d7',
