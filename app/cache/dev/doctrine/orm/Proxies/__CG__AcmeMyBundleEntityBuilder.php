 ...
 */
class Builder extends \Acme\MyBundle\Entity\Builder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'communities', 'description', 'id', 'logo', 'name', 'website');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Builder $proxy) {
