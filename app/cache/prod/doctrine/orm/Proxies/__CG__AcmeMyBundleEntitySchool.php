 ...
 */
class School extends \Acme\MyBundle\Entity\School implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'address', 'communities', 'description', 'id', 'name', 'ranking', 'type', 'score', 'url');
        }
