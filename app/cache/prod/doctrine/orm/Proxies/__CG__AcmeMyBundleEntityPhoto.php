 ...
 */
class Photo extends \Acme\MyBundle\Entity\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\MyBundle\\Entity\\Photo' . "\0" . 'album', 'id', 'name', 'path');
        }
