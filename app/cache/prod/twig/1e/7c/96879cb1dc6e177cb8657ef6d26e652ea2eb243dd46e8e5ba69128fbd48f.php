...
\t\t\t\t\t\t\t\t<td scope=\"row\">价格： ";
            // line 81
            echo twig_escape_filter($this->env, twig_round((($this->getAttribute((isset($context["prices"]) ? $context["prices"] : null), $context["id"], array(), "array") * 6.3) / 10000)), "html", null, true);
            echo " 万元起</td>
\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t</tbody>
\t\t\t\t\t</table>
...
<script type=\"text/javascript\">
    function getMap(){
        ...
        // line 101
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["map_center"]) ? $context["map_center"] : null), "latitude", array(), "array"), "html", null, true);
        echo ", ";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["map_center"]) ? $context["map_center"] : null), "longitude", array(), "array"), "html", null, true);
        echo "),
